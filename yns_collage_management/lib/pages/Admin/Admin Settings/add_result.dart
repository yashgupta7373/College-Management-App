...
import 'package:yns_college_management/pages/Result/result.dart';

import '../../../Resources/firestore_method_for_result.dart';

class AddResultScreen extends StatefulWidget {
  String uid;
  AddResultScreen({required this.uid, super.key});
...
// showDialog & select Image...
  ...
  //upload Result..
  void resultImage(String uid, String name, String photoUrl) async {
    setState(() {
      isLoading = true;
    });
    // start the loading
    try {
      ...
      String res = await FireStoreMethods().uploadResult(
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                TextButton(
                    onPressed: () {
                      resultImage(userData['uid'], userData['name'],
                          userData['photoUrl']);
                    },
                    child: Row(
                      children: const [
