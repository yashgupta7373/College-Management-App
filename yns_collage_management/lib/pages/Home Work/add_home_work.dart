...
import 'package:yns_college_management/pages/Home%20Work/home_work.dart';

import '../../Resources/firestore_method_for_homework.dart';

class AddHomeWorkScreen extends StatefulWidget {
  String uid;
  AddHomeWorkScreen({required this.uid, super.key});
...
// showDialog & select Image...
  ...
  //upload HomeWork..
  void homeWorkImage(String uid, String name, String photoUrl) async {
    setState(() {
      isLoading = true;
    });
    // start the loading
    try {
      ...
      String res = await FireStoreMethods().uploadHomeWork(
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                TextButton(
                    onPressed: () {
                      homeWorkImage(userData['uid'], userData['name'],
                          userData['photoUrl']);
                    },
                    child: Row(
                      children: const [
